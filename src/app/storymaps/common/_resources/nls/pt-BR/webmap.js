define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Localizador de Endereço, Local",
      ...
      "tooltipGeocoderNoEdit": "Permite que seus leitores pesquisem endereços, locais e/ou feições no mapa.",
      "tooltipGeocoderNoFeatures": "Permita seus leitores pesquisar por endereços e locais neste mapa. Para habilitar a pesquisa de feição, peça ao proprietário deste mapa para configurá-lo na página de item do mapa da web em Configurações > Mapa da Web > Aplicativo > Encontrar Local.",
      "linkGeocoder": "Configurar pesquisa de mapa",
      "tooltipGeocoderLink": "Utilize este link para configurar a pesquisa de feição e outras opções de pesquisa. Consulte o tópico de ajuda do ArcGIS &quot;Configurar pesquisa de feição&quot; para mais informações.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Encontrar endereço ou lugar",
