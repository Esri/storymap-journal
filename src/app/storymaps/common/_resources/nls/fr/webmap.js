define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Répertoire géographique",
      ...
      "tooltipGeocoderNoEdit": "Permettez à vos lecteurs de rechercher des adresses, endroits et/ou entités sur la carte.",
      "tooltipGeocoderNoFeatures": "Permettez à vos lecteurs de rechercher des adresses et endroits sur cette carte. Pour activer la recherche d’entités, demandez au propriétaire de cette carte de la configurer sur la page des éléments de la carte Web, sous Paramètres > Carte Web > Application > Rechercher un emplacement.",
      "linkGeocoder": "Configurer la recherche dans une carte",
      "tooltipGeocoderLink": "Utilisez ce lien pour configurer la recherche d’entités et d’autres options de recherche. Consultez la rubrique d’Aide ArcGIS « Configurer la recherche d'entités » pour plus d’informations.",
      "lblEsriGeocoder": "Répertoire géographique mondial",
      "placeholderGenericGeocoder": "Rechercher une adresse ou un lieu",
