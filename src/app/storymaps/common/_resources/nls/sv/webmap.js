define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Sökning efter adresser och platser",
      ...
      "tooltipGeocoderNoEdit": "Låt dina läsare söka efter adresser, platser och/eller geoobjekt på kartan.",
      "tooltipGeocoderNoFeatures": "Låt dina läsare söka efter adresser och platser på den här kartan. Om du vill aktivera sökning efter geoobjekt ber du ägaren av kartan att ställa in det på webbkartans objektssida under Inställningar > Webbkarta > Program > Hitta platser.",
      "linkGeocoder": "Konfigurera kartsökning",
      "tooltipGeocoderLink": "Använd denna länk för att konfigurera geoobjektssökning och andra sökalternativ. Se ArcGIS-hjälpavsnittet Konfigurera geoobjektssökning för mer information.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Sök efter adress eller plats",
