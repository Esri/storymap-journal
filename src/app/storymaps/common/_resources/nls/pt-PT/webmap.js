define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Localizador (Finder) de Endereços e Locais",
      ...
      "tooltipGeocoderNoEdit": "Permita que os seus leitores procurem endereços, locais e/ou elementos no mapa.",
      "tooltipGeocoderNoFeatures": "Permita que os seus leitores procurem endereços e locais neste mapa. Para ativar a pesquisa de elementos, peça ao proprietário deste mapa que o configure na página do item do mapa web, em Definições > Mapa Web > Aplicação > Encontrar Locais.",
      "linkGeocoder": "Configurar pequisa de mapas",
      "tooltipGeocoderLink": "Utilize esta ligação para configurar a pesquisa de elementos e outras opções de pesquisa. Consulte o tópico de ajuda de ArcGIS &quot;Configurar pesquisa de elementos&quot; para obter mais informações.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Encontrar um endereço ou local",
