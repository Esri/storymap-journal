define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Adresse og Stedsfinner",
      ...
      "tooltipGeocoderNoEdit": "La leserne søke etter adresser, steder og/eller geoobjekter på kartet.",
      "tooltipGeocoderNoFeatures": "La leserne søke etter adresser og steder på dette kartet. For å aktivere geoobjektsøk ber du eieren av dette kartet om å konfigurere det på webkartets elementside under Innstillinger> Webkart > Applikasjon > Finn lokasjoner.",
      "linkGeocoder": "Konfigurer kartsøk",
      "tooltipGeocoderLink": "Bruk denne koblingen til å geoobjektsøk og andre søkealternativer. Se ArcGIS-hjelpeemnet «Konfigurer geoobjektsøk» for mer informasjon.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Finn adresse eller sted",
