define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "住所および場所の検索",
      "tooltipGeocoder": "ユーザーがマップ上の住所、場所、フィーチャを検索できるようにします。検索オプションは、Web マップのアイテム ページで、[設定] → [Web マップ] → [アプリケーション] → [位置の検索] から構成できます。",
      "tooltipGeocoderNoEdit": "ユーザーがマップ上の住所、場所、フィーチャを検索できるようにします。",
      "tooltipGeocoderNoFeatures": "ユーザーがマップ上の住所と場所を検索できるようにします。フィーチャ検索を有効にするには、このマップの所有者に依頼して、Web マップのアイテム ページの [設定] → [Web マップ] → [アプリケーション] → [位置の検索] から構成してもらいます。",
      "linkGeocoder": "マップ検索の構成",
      "tooltipGeocoderLink": "このリンクを使用すると、フィーチャ検索と他の検索オプションを構成できます。詳細については、ArcGIS ヘルプの「フィーチャ検索の構成」をご参照ください。",
      "lblEsriGeocoder": "場所検索",
      "placeholderGenericGeocoder": "住所または場所の検索",
