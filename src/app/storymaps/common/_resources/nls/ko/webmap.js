define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "주소 및 장소 찾기",
      "tooltipGeocoder": "독자가 맵에서 주소, 장소 및/또는 피처를 검색할 수 있습니다. 검색 옵션은 웹 맵 항목 페이지의 설정 > 웹 맵 > 응용프로그램 > 위치 찾기에서 구성할 수 있습니다.",
      "tooltipGeocoderNoEdit": "독자가 맵에서 주소, 장소 및/또는 피처를 검색할 수 있습니다.",
      "tooltipGeocoderNoFeatures": "독자가 이 맵에서 주소와 장소를 검색할 수 있습니다. 피처 검색을 활성화하려면 이 맵의 소유자에게 웹 맵 항목 페이지의 설정 > 웹 맵 > 응용프로그램 > 위치 찾기에서 피처 검색을 구성하도록 요청하세요.",
