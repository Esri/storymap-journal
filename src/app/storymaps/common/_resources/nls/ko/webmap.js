define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "주소, 장소 찾기",
      ...
      "tooltipGeocoderNoEdit": "독자가 맵에서 주소, 장소, 피처를 검색할 수 있습니다.",
      "tooltipGeocoderNoFeatures": "독자가 이 맵에서 주소와 장소를 검색할 수 있습니다. 피처 검색을 활성화하려면 이 맵의 소유자에게 웹 맵 항목 페이지의 설정(Setting) > 웹 맵(Web Map) > 응용프로그램(Application) > 위치 찾기(Find Locations)에서 피처 검색을 구성하도록 요청하세요.",
      "linkGeocoder": "맵 검색 구성",
      "tooltipGeocoderLink": "이 링크를 사용하여 피처 검색 및 기타 검색 옵션을 구성할 수 있습니다. 자세한 내용은 ArcGIS 도움말 항목 &quot;피처 검색 구성&quot;을 참고하세요.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "주소 또는 장소 찾기",
      ...
      "tooltipOverview": "기본 맵과 함께 소형 오버뷰보기 맵을 표시합니다.",
