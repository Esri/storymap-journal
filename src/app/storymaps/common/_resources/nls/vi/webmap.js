define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Trình tìm kiếm Địa chỉ và Địa điểm",
      ...
      "tooltipGeocoderNoEdit": "Cho phép người xem của bạn tìm kiếm địa chỉ, địa điểm, và/hoặc các đối tượng trên bản đồ.",
      "tooltipGeocoderNoFeatures": "Cho phép người xem của bạn tìm kiếm địa chỉ và các địa điểm trên bản đồ. Để kích hoạt tính năng tìm kiếm đối tượng, yêu cầu người sở hữu bản đồ này cấu hình trên trang mục của bản đồ web trong phần Cài đặt > Bản đồ Web > Ứng dụng > Tìm các Vị trí.",
      "linkGeocoder": "Cấu hình tính năng tìm kiếm bản đồ",
      "tooltipGeocoderLink": "Sử dụng liên kết này để cấu hình các tùy chọn tìm kiếm đối tượng và các tùy chọn tìm kiếm khác. Xem chủ đề trợ giúp ArcGIS &quot; Cấu hình tùy chọn tìm kiếm đối tượng&quot; để biết thêm thông tin.",
      "lblEsriGeocoder": "Trình tìm kiếm Địa chỉ trên Toàn cầu",
      "placeholderGenericGeocoder": "Tìm địa chỉ hoặc địa điểm",
