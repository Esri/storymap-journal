define({
  "commonCore": {
    ...
    "extendedSupportMessage": {
      ...
      "action1": "Закрыть",
      "action2": "Подробнее",
      "action3": "Один или несколько классических шаблонов могут быть добавлены в пользовательскую группу настраиваемых приложений вашей организации, если это необходимо для поддержки текущих рабочих процессов во время перехода к использованию ArcGIS StoryMaps."
    },
