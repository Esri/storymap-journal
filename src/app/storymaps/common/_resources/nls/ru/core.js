	...
	({
		commonCore: {
			...
			saveError: {
				...
				err1Div2: "Измените заголовок главного раздела и сохраните приложение.",
				btnOk: "Изменить заголовок главного раздела"
			},
			share: {
				...
				shareQ0: "Как мне встроить приложение в веб-сайт?",
