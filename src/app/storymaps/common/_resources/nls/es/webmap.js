define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Buscador de direcciones y lugares",
      ...
      "tooltipGeocoderNoEdit": "Permita a sus lectores buscar direcciones, lugares y entidades en el mapa.",
      "tooltipGeocoderNoFeatures": "Permita a sus lectores buscar direcciones y lugares en este mapa. Para habilitar la búsqueda de entidades, pida al propietario del mapa que lo configure en la página de elemento del mapa web en Configuración > Mapa web > Aplicación > Buscar ubicaciones.",
      "linkGeocoder": "Configurar búsqueda en el mapa",
      "tooltipGeocoderLink": "Use este vínculo para configurar la búsqueda de entidades y otras opciones de búsqueda. Consulte el tema de la Ayuda de ArcGIS &quot;Configurar búsqueda de entidades&quot; para obtener más información.",
      "lblEsriGeocoder": "Buscador de lugares del mundo",
      "placeholderGenericGeocoder": "Buscar dirección o lugar",
