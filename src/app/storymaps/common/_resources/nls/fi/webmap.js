define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Osoitteen ja paikan etsiminen",
      ...
      "tooltipGeocoderNoEdit": "Salli lukijoiden etsiä osoitteita, paikkoja ja/tai kohteita kartalta.",
      "tooltipGeocoderNoFeatures": "Salli lukijoiden etsiä osoitteita ja paikkoja tältä kartalta. Jos haluat ottaa käyttöön kohdehaun, pyydä tämän kartan omistajaa määrittämään se Web-kartan kohdesivulla kohdassa Asetukset > Web-kartta > Sovellus > Etsi sijainteja.",
      "linkGeocoder": "Määritä karttahaku",
      "tooltipGeocoderLink": "Tämän linkin avulla voit määrittää kohdehaun ja muita hakuasetuksia. Lisätietoja on ArcGIS-ohjeaiheessa &quot;Kohdehaun määrittäminen&quot;.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Etsi osoite tai paikka",
