define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "地址和地点查找器",
      "tooltipGeocoder": "允许读者在地图上搜索地址、地点和/或要素。可在 Web 地图项目页面的设置 > Web 地图 > 应用程序 > 查找位置下对搜索选项进行配置。",
      "tooltipGeocoderNoEdit": "允许读者在地图上搜索地址、地点和/或要素。",
      "tooltipGeocoderNoFeatures": "允许读者在地图上搜索地址和地点。要启用要素搜索，请告知地图所有者对其进行配置，具体位于设置 > Web 地图 > 应用程序 > 查找位置下的 Web 地图项目页面内。",
      "linkGeocoder": "配置地图搜索",
      "tooltipGeocoderLink": "使用此链接来配置要素搜索和其他搜索选项。有关详细信息，请参阅 ArcGIS 帮助主题&quot;配置要素搜索&quot;。",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "查找地址或地点",
      "loadingTitle": "加载标题",
      "entry": "条目",
      "entries": "条目",
      "section": "节",
