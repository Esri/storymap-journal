define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "Εύρεση διεύθυνσης και μέρους",
      ...
      "tooltipGeocoderNoEdit": "Μπορείτε να επιτρέψετε στους αναγνώστες σας να αναζητούν διευθύνσεις, μέρη ή/και στοιχεία στον χάρτη.",
      "tooltipGeocoderNoFeatures": "Μπορείτε να επιτρέψετε στους αναγνώστες σας να αναζητούν διευθύνσεις και μέρη σε αυτόν τον χάρτη. Για να ενεργοποιήσετε την αναζήτηση στοιχείων, ζητήστε από τον κάτοχο του χάρτη να τη διαμορφώσει στη σελίδα αντικειμένων του web χάρτη, στο μενού Settings > Web Map > Application > Find Locations.",
      "linkGeocoder": "Διαμόρφωση αναζήτησης στον χάρτη",
      "tooltipGeocoderLink": "Χρησιμοποιήστε αυτόν τον σύνδεσμο για να διαμορφώσετε την αναζήτηση στοιχείων και άλλες επιλογές αναζήτησης. Ανατρέξτε στο θέμα βοήθειας της ArcGIS, &quot;Διαμόρφωση αναζήτησης στοιχείων&quot; για περισσότερες πληροφορίες.",
      "lblEsriGeocoder": "World Placefinder",
      "placeholderGenericGeocoder": "Αναζήτηση διεύθυνσης ή μέρους",
