define({
  "commonWebmap": {
    "selector": {
      ...
      "lblGeocoderNoFeatures": "ที่อยู่และ Place Finder",
      ...
      "tooltipGeocoderNoEdit": "ช่วยให้ผู้อ่านของคุณเพื่อค้นหาที่อยู่สถานที่และ / หรือฟีเจอร์บนแผนที่",
      "tooltipGeocoderNoFeatures": "ช่วยให้ผู้อ่านของคุณเพื่อค้นหาที่อยู่และสถานที่บนแผนที่นี้ ต้องการเปิดใช้งานการค้นหาคุณลักษณะขอให้เจ้าของของแผนที่นี้ในการกำหนดค่าในหน้ารายการแผนที่เว็บภายใต้การตั้งค่า> เว็บแผนที่> Application> ค้นหาสถานที่",
      "linkGeocoder": "กำหนดค่าการค้นหาแผนที่",
      "tooltipGeocoderLink": "ใช้ลิงค์นี้เพื่อกำหนดค่าการค้นหาคุณลักษณะและตัวเลือกการค้นหาอื่น ๆ ดูหัวข้อ ArcGIS ช่วยเหลือ & quot; กำหนดค่าคุณลักษณะการค้นหา & quot; สำหรับข้อมูลเพิ่มเติม.",
      "lblEsriGeocoder": "โลก Placefinder",
      "placeholderGenericGeocoder": "ค้นหาที่อยู่หรือสถานที่",
