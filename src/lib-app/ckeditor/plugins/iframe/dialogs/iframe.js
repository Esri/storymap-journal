    ...
    CKEDITOR.dialog.add("iframe", function (b) {
        ...
        return {
            ...
            onShow: function () {
    			 ...
    			 * Esri
    			 * 
    			 * As I haven't found a proper way to open the custom inlineMedia dialog when doubleclicking on iframe
    			 *  - hide the popup
    			 *  - trigger an event that will be catched by storymapsInlineMedia plugin and will open the custom dialog
    			 */
    			CKEDITOR.dialog.getCurrent().hide();
    			
    			require(["dojo/topic"], function(topic){
    				topic.publish("EDITOR-DOUBLE-CLICK-IMAGE", {});
    			});
