define({
  "viewer": {
    ...
    "a11y": {
      "skipToContent": "Ugrás a történetre",
      "headerAria": "Történet fejléce",
      "panelAria": "A történet forgatókönyve",
      "mainStageAria": "Média a történet aktuális szekciójában",
      "logoLinkAria": "Logó hivatkozása",
      "toTop": "Ugrás a történet elejére",
      "focusContent": "Vissza a történethez",
      "navAria": "Történet szekciói",
      "navPreviousAria": "Előző szekció",
      "navNextAria": "Következő szekció",
      "toSectionAria": "Ugrás a(z) %SECTION_NUMBER%. szekcióhoz: %SECTION_TITLE%",
      "toNextGroupAria": "Következő szekciócsoport (%SECTION_RANGE%)",
      "toPrevGroupAria": "Előző szekciócsoport (%SECTION_RANGE%)",
    ...
    "loading": {
      ...
      "step3": "Inicializálás",
      "loadBuilder": "Váltás a szerkesztőre",
      "long": "A Map Journal inicializálása folyamatban van",
      "long2": "Kérjük, várjon",
    ...
    "mobileView": {
      ...
      "clickForDetails": "További információk",
      "swipeToExplore": "Pöccintsen a böngészéshez",
      "tapForMap": "Koppintson a visszalépéshez",
      "clickForMap": "VISSZA"
    },
    "floatLayout": {
      "scroll": "Görgetés"
    ...
    "sideLayout": {
      "scroll": "Görgetessen lefelé a további tartalomért!"
    },
    "mainStage": {
      "back": "Vissza",
    ...
    "headerFromCommon": {
      ...
      "bitlyTooltip": "Megosztás vagy nyomtatás",
    ...
    "shareFromCommon": {
      ...
      "embedExplain": "A következő HTML-kód használatával ágyazhatja be a médiatérképet a weboldalakon.",
      ...
      "print": "Nyomtatás",
      "printInstruction1": "Várjon, amíg betöltődik a teljes történet, mielőtt kinyomtatja",
      "printInstruction1a": "Ha ez az oldal lassan töltődik be, vagy valamelyik média nem jelenik meg, próbáljon meg kisebb terjedelmű szekciókat kinyomtatni.",
      "printInstruction1b": "A legjobb eredmények érdekében szükség lehet a háttérelemek nyomtatásának engedélyezésére böngészője nyomtatási beállításaiban.",
      "printInstruction2": "Ez az oldal nem osztható meg másokkal, ehelyett válassza a ${link} megosztását",
      "link": "történetre mutató hivatkozás",
      "optionsHeader": "Beállítások",
      "printOptPageBreak": "Minden szekció új oldalon kezdődjön",
      "makeTextBlack": "Az összes szöveg legyen fekete",
      "showLinks": "URL-hivatkozások megjelenítése",
      "madeWith": "Ez a történet ${JOURNAL_LINK_TEXT} használatával készült.",
      "journalLinkText": "Esri Story Map Journal",
      "readItOnline": "Olvassa el az interaktív változatot az interneten: ${link}.",
      "printMSWarning": "csak az online történetben elérhető hivatkozás",
      "printVideoWarning": "Ez a videó csak a story map online verziójában tekinthető meg",
      "printRangeHeader": "A történet egy részének nyomtatása",
      "sectionLabel": "Szekciók:",
      "apply": "Alkalmaz",
      "resetRange": "Teljes történet visszaállítása"
    }
  }
});