define({
  "viewer": {
    ...
    "errors": {
      ...
      "invalidApp": "%TPL_NAME%이(가) 존재하지 않거나 여기에 접근할 수 없습니다.",
      ...
      "noViewerIE3": "2017년 후반부터는 이 스토리를 해당 브라우저에서 불러올 수 없으므로 스토리를 보려면 지원되는 브라우저를 사용해야 합니다.",
    ...
    "shareFromCommon": {
      ...
      "open": "열기",
      "embed": "웹페이지에 포함",
      "embedExplain": "다음 HTML 코드를 사용하여 저널을 웹페이지에 포함시킵니다.",
      "size": "크기(너비/높이):",
      ...
      "journalLinkText": "Esri 스토리 Map Journal",
      "readItOnline": "웹(${link})에서 대화형 버전을 읽어보세요.",
      "printMSWarning": "온라인 스토리에서만 제공되는 링크",
      "printVideoWarning": "이 비디오는 온라인 버전의 이 스토리맵에서 볼 수 있음",
