	 ...
	 ({
		builder: {
			...
			help: {
				...
				content5Div1: "يتم حفظ %TPL_NAME% على حساب %PORTAL% والخاص افتراضيًا. يمكن إقرار مشاركته مع المؤسسة أو فتحه على العالم. سندعمك بعنوان URL مختصر لتتمكن من مشاركته بشكل أكثر سهولة.",
