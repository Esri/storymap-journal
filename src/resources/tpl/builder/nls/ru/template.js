	 ...
	 ({
		builder: {
			...
			help: {
				...
				content5Div2: "В зависимости от учетной записи, у вас также может быть опция для предоставления доступа к %TPL_NAME% только для участников вашей организации, т.е. другие пользователи не смогут открыть его.",
