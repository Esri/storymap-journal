define({
  "builder": {
    ...
    "help": {
      ...
      "content4Div1": "Encontrou um erro ou quer alterar o seu material? Não se preocupe. Procure o ícone de edição na aplicação para fazer alterações ao seu conteúdo. Irá utilizar as funções de edição várias vezes enquanto desenvolve o seu %TPL_NAME%!",
    ...
    "landing": {
      ...
      "quote5": "Acredito realmente que as pessoas procuram histórias com significado real, redentoras, inspiradoras e maiores do que um indivíduo.",
      ...
      "quote12": "As histórias são a arma mais poderosa do arsenal de um líder.",
