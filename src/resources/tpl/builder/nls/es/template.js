	 ...
	 ({
		builder: {
			...
			exportData: {
				...
				tooltip: "La exportación del contenido te permite ver y crear una copia de seguridad del diario por si lo suprimes accidentalmente. Solo tienes que copiar y pegar el contenido de la página en cualquier procesador de texto."
			},
			help: {
				lblHelp: "Ayuda",
				...
				content6Div1: "El título de tu sección de inicio es también el título de tu diario. Piensa en la sección de inicio como si fuera la portada de tu historia. El título de la sección de inicio seguirá estando visible para los lectores cuando accedan al diario.",
