define({
  "builder": {
    "layouts": {
      ...
      "sideDescr": "Izkārtojums ar informatīvam stāstam, kas ļauj kombinēt fotoattēlus, video un kartes skaidrā un viegli uztveramā ziņojumā.",
    ...
    "help": {
      ...
      "content4Div1": "Pamanījāt kļūdu vai vēlaties mainīt saturu? Neuztraucieties. Meklējiet lietotnē rediģēšanas ikonu, lai veiktu izmaiņas saturā. Veidojot savu %TPL_NAME%, rediģēšanas funkcijas jūs izmantosiet daudzas reizes!",
    ...
    "landing": {
      ...
      "lblOR": "Vai",
      "lblHelp": "Iepazīties ar aprakstu",
      ...
      "quote4": "Cilvēki dzīvo informācijas pārpilnības laikmetā. Viņi slīgst informācijas jūrā. Viņi vēlas uzticēties jums, jūsu mērķiem, piemēriem, veiksmei un stāstam.",
      "quote5": "Es patiesi ticu, ka cilvēki meklē jēgpilnus stāstus, kas ir atslogojoši, iedvesmojoši un ar plašu nozīmi.",
      "quote6": "Ja vēlaties ietekmēt sabiedrības viedokli, izklāstiet ideju aizraujoša stāsta veidā.",
