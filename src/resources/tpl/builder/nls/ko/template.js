	 ...
	 ({
		builder: {
			...
			addEditPopup: {
				...
				titleEdit: "섹션 편집",
				step: "단계",
				stepMainStageExplain: "기본 단계 컨텐츠",
				stepPanelExplain: "컨텐츠",
			...
			exportData: {
				btn: "컨텐츠 내보내기",
				tooltip: "실수로 저널의 삭제한 경우 컨텐츠 내보내기를 통해 저널의 백업을 확인하고 생성할 수 있습니다. 페이지 컨텐츠를 복사하여 워드 프로세서에 붙여 넣기만 하면 됩니다."
			},
			help: {
				lblHelp: "도움말",
				lblAdd: "섹션 추가",
				...
				content3Div1: "컨텐츠는 섹션으로 구성됩니다. 원하는 수의 섹션(일종의 작은 챕터)을 만들 수 있습니다. 이러한 챕터의 흐름이 중요하며, 구성에서 원하는 대로 섹션을 삭제하거나 재정렬할 수 있습니다.",
